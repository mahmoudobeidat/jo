...
if (isset($_POST['send'])) {
      ...
      $upload_dir = 'mail_files/';
            ...
            move_uploaded_file($file_tmpname, $filepath);
                 ...
                 $file = implode(',', $file).",".$_POST['file'];
               
     
      $query="INSERT INTO `mails`( `to`, `subject`,`file`, `from`, `description`, `date`, `time`) VALUES ('$to','$subject','$file','$id','$msg','$date','$time')";
            ...
            <div class="carousel-control-next listrightslider" >
                ...
                <img class="my-1 mr-3" src="img/font3.png" alt="" />
                       ...
                       <button style="border:none;" id="checkbox"><img class="my-1" id="mydark" src="img/picture (1).png" alt=""></button>
                        <button style="border:none;" ><img class="my-1" id="yellow" src="img/picture (1)0.png" alt=""></button>
                          <button style="border:none;" ><img class="my-1" id="mylight" src="img/picture (2).png" alt=""></button>
                          <button style="border:none;" ><img class="my-1" src="img/visibility.png" alt=""></button>
                          <button style="border:none;" ><img class="my-1" src="img/invisible.png" alt=""></button>
                  ...
                  <aside class="lg-side">
                      ...
                      <div class="inbox-body">
                         <div class="mail-option">
                          ...
                          <h3 style="float: right;">البريد الوارد</h3>
                      ...
                      <div class="inbox-body">
                         <div class="mail-option">
                          ...
                          <table  class="table table-inbox table-hover">
                                  ...
                                  <td class="view-message  text-center ">من</td>
...
$query="SELECT users.id as uid,users.fname,users.lname,`mail_id`, `to`, `subject`, `foreword`, `file`, `from`, `description`,mails.date, `time`        FROM `mails`
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
              ...
              <input hidden name="id" id="mail_id">
      ...
      <div class="form-group">
        <label  for="exampleFormControlInput1">تحويل</label>
    ...
    elseif($type==2){
           $query="SELECT *
            FROM users 
            WHERE (type=1 and dept_id='$dept_id') or (type=3 and dept_id=$dept_id)and type NOT LIKE '2' ";
            $result=mysqli_query($con,$query);
    while ($row=mysqli_fetch_assoc($result)) {
            echo "<option value='". $row['id'] ."'>" .$row['email'] ."</option>";  // displaying data in option menu
    ...
    // from chearman to all employee ,managers and head of departments,
            ...
            elseif($type==4){
                $query="SELECT * FROM `users` WHERE type NOT LIKE '4'";
                $result=mysqli_query($con,$query);
    while ($row=mysqli_fetch_assoc($result)) {
            echo "<option value='". $row['id'] ."'>" .$row['email'] ."</option>";  // displaying data in option menu
    ...
    <label for="exampleFormControlTextarea1">الوصف</label>
        <textarea style="overflow-y:scroll;" class="form-control" id="msg" value="hhhh" name="msg"  placeholder="نص الرسالة"  rows="10" required>
    ...
    <input class="form-control" name="image[]" size="50" type="file" id="formFileMultiple" multiple />
      <div class="modal-footer">
        ...
        <input style="margin: 15px;" type="submit" name="send" value="ارسال" class="btn btn-primary">
